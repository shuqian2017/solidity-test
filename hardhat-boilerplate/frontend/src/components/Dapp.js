...
export class Dapp extends React.Component {
    ...
    render() {
        ...
        return (
            ...
            */}
                        {this.state.transactionError && <TransactionErrorMessage message={this._getRpcErrorMessage(this.state.transactionError)} dismiss={() => this._dismissTransactionError()} />}
                    </div>
                </div>
            ...
            */}
              ...
              callback.
            */}
                        {this.state.balance.gt(0) && <Transfer transferTokens={(to, amount) => this._transferTokens(to, amount)} tokenSymbol={this.state.tokenData.symbol} />}
                    </div>
                </div>
            </div>
        );
